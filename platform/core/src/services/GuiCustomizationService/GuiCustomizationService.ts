...
export default class GuiCustomizationService extends PubSubService {
  ...
  setModeCustomization(id, button) {
    this.modeCustomizations[id] = merge(this.modeCustomizations[id] || {}, button);
   ...
   */
  getGlobalCustomization(id: string, defaultValue?: Types.IGuiCustomization): Types.IGuiCustomization | void {
